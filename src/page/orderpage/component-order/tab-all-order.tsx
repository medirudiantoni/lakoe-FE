...
import { Link } from 'react-router'; // ✅ Perbaiki import Router
...
export function TabAllOrder() {
  ...
  // ✅ Mapping status ke warna Chakra UI
  ...
  // ✅ Fungsi untuk menentukan label tombol berdasarkan status
  ...
  {order.invoice?.invoiceNumber || "No Invoice"}
                    ...
                    <Button variant="outline" borderRadius="20px">
                      {getButtonLabel(order.status)} {/* ✅ Pakai label dinamis */}
                    </Button>
                  </Box>
