      ...
      <section className="w-full min-h-screen flex items-end pt-60">
        <VStack alignItems="start" w="full" maxW="7xl" mx="auto">
          ...
          >
            ...
            >
              Kami hadir untuk membantu anda menaklukkan dunia
            </Text>
            <Text
              maxW="xl"
              fontSize="xl"
            ...
            >
              ...
              Dengan platform kami, Anda bisa menciptakan website jualan sendiri
              yang profesional, tanpa komisi yang memotong keuntungan. Kendali
              penuh, keuntungan maksimal, semuanya dirancang untuk membuat
              bisnis Anda bersinar.
            </Text>
          </HStack>
        ...
        <HStack w="full" maxW="7xl" mx="auto">
          <VStack alignItems="start" w="4/6" pr="20" mt={-10}>
            ...
            <Text fontSize="xl" ml={'2'} color={'gray.600'}>
              ...
              pebisnis yang bebas dari persaingan baik komoditas maupun harga
              dengan seller lain seperti pada platform e-commerce konvensional.{' '}
              <br />
              Selain itu juga dengan tujuan untuk memaksimalkan margin dan
              pendapatan pengguna disetiap transaksi yang terjadi tanpa ada
              potongan sedikitpun sehingga setiap keuntungan adalah milik
              pengguna. Dengan hanya membayar langganan saja, pengguna sudah
              menjadi seller yang bisa memaksimalkan keuntungan tanpa potongan
              meskipun transaksinya miliaran.{' '}
            </Text>
          </VStack>
