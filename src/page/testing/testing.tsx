    ...
    acc.forEach(existing => {
      variant.options.forEach(opt => {
        newCombinations.push({
          ...
          variants: [...existing.variants, {variantName: variant.name, optionName: opt.name}]
        });
      });
    });
...
const ProductVariantManager: React.FC = () => {
  ...
  const handleUpdateFinalValue = (optionId: number, field: keyof VariantOptionValue, value: string | number): void => {
    setFinalVariant(prev => ({
      ...prev,
  ...
  const handleInputChange = (e: ChangeEvent<HTMLInputElement>, field: keyof VariantOptionValue, optionId: number): void => {
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-4 mb-6">
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => setNewVariantName(e.target.value)}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange(e, 'weight', option.id)}
                      className="px-3 py-2 border rounded-lg w-full"
                    />
                  </div>
                  <div>
