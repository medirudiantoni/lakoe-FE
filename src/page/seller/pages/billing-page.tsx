        ...
        <Box w="full" maxW="xl">
          ...
          <Table.Root size="lg" mb="5">
            <Table.Body>
              ...
              <Table.Row>
                <Table.Cell px="0">
                  Atau Scan QR code ini untuk pembayaran
                </Table.Cell>
                <Table.Cell px="0" textAlign="end">
                  <HStack justifyContent="end">
                    <Image
                      ...
                      h="fit"
                      objectFit="contain"
                      src="https://i.pinimg.com/736x/96/7e/f2/967ef2c1c4a690bb332fd91413d0393a.jpg"
                    />
                  </HStack>
                </Table.Cell>
              </Table.Row>
          ...
          <HStack>
            ...
            <Button flex={1} onClick={() => navigate(`/${store?.name}/buyer`)}>
              Lihat Pesanan
            </Button>
          </HStack>
        </Box>
