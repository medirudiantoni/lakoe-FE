...
export const dummy_product = [
  {
    ...
    attachments: [
      ...
      'https://i.pinimg.com/736x/6a/ff/7b/6aff7b9d1a097538cf3cd93b9ce90c57.jpg',
    ],
  },
  {
    id: 2,
    ...
    price: 'Rp 1.343.500,-',
    attachments: [
      'https://i.pinimg.com/736x/76/1c/49/761c49926373a605a71391d1272c5cf0.jpg',
      'https://i.pinimg.com/736x/37/25/63/3725630bee7ef38841a03f1ad9d5b5f4.jpg',
    ],
  },
  {
    id: 3,
    ...
    price: 'Rp 23.240.500,-',
    attachments: [
      'https://i.pinimg.com/736x/00/48/a7/0048a7ec27539ccd6437b7b0087f4108.jpg',
      'https://i.pinimg.com/736x/ea/99/81/ea99810744a9257d8cf09d4214ac5c27.jpg',
      'https://i.pinimg.com/736x/8e/db/b0/8edbb010eee8a26f44ff331e281df5dd.jpg',
      'https://i.pinimg.com/736x/be/18/49/be18494fd2e3638dc40cd533f611da98.jpg',
    ],
  },
  {
    id: 4,
    ...
    price: 'Rp 16.240.500,-',
    attachments: [
      'https://i.pinimg.com/736x/36/49/97/36499765914857e715c672592fb9fa15.jpg',
      'https://i.pinimg.com/736x/af/70/c5/af70c59d48f929899c16dd7fc4473737.jpg',
    ],
  },
];
  ...
  return (
    <Box w="full" h="fit" minH="100vh">
        ...
        <form className="flex-1">
          <HStack w="full" borderRadius="lg" bg="gray.200" px="2">
            ...
            <Input
              ...
              _placeholder={{ fontWeight: '400', fontSize: 'md' }}
              focusRing={'none'}
              px="0"
              borderWidth="0"
            ></Input>
      ...
      <HStack
        ...
        py="10"
      >
        <Heading size="3xl" fontWeight="semibold" className="font-poppins">
          Semua Produk
        </Heading>
        <HStack>
