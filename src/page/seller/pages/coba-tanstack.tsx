...
const CobaTanstack = () => {
    ...
    if (error) return <Center w="full" h="100vh"><Heading size="xl" fontWeight="semibold">Oops, something went wrong!</Heading></Center>
    ...
    return (
        <Box w="full" minH="100vh" className="bg-slate-200 py-20 font-poppins">
            <div className="w-full max-w-2xl mx-auto p-5 border-2 rounded-lg bg-white">
                ...
                <div>
                    <Button w="full" onClick={() => navigate('/cache')}>ke halaman Cache</Button>
                </div>
            </div>
        </Box>
    )
