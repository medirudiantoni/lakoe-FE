...
const ButtonDialogVariantType: React.FC<ButtonDialogVariantTypeProps> = ({ value }) => {
                ...
                <DialogBody>
                    <Stack gap={4}>
                        <Field label="Nama Variant">
                            <Input value={isValue} onChange={(e) => setValue(e.target.value)} placeholder="Nama Variant Baru" />
                        </Field>
                    </Stack>
                </DialogBody>
                <DialogFooter>
